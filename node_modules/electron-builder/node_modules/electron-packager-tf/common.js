...
module.exports = {
  ...
  initializeApp: function initializeApp (opts, templatePath, appRelativePath, callback) {
    ...
    var operations = [
      function (cb) {
        fsExtra.move(templatePath, tempPath, {clobber: true}, cb)
      },
      function (cb) {
        fsExtra.copy(opts.dir, appPath, {filter: userIgnoreFilter(opts), dereference: true}, cb)
      },
      function (cb) {
  ...
  moveApp: function finalizeApp (opts, tempPath, callback) {
    ...
    fsExtra.move(tempPath, finalPath, function (err) {
